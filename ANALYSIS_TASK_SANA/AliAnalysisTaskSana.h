#ifndef AliAnalysisTaskSana_cxx
#define AliAnalysisTaskSana_cxx
...
class AliAnalysisTaskSana : public AliAnalysisTaskSE {
    
public:
    AliAnalysisTaskSana();
    AliAnalysisTaskSana(const char *name);
    virtual ~AliAnalysisTaskSana();
...
private:
    ...
    AliAnalysisTaskSana(const AliAnalysisTaskSana&);
    AliAnalysisTaskSana& operator=(const AliAnalysisTaskSana&);
    
    ClassDef(AliAnalysisTaskSana, 1);
};
#endif
