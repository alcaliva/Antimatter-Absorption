...
#define GRIDWorkingDir  "Sana_DIR"
#define AnalysisMacro   "AnalysisSana"
#define AnalysisTask    "AliAnalysisTaskSana"
#define TTL             20000
